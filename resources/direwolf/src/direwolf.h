...
#ifndef MAX_ADEVS
#define MAX_ADEVS 1     /* wfweb: shrunk from upstream 3 — single audio dev */
#endif
...
#ifndef MAX_RADIO_CHANS
#define MAX_RADIO_CHANS 2     /* wfweb: ch0 = 1200 AFSK, ch1 = 9600 FSK */
#endif
...
#ifndef MAX_SUBCHANS
#define MAX_SUBCHANS 2     /* wfweb: shrunk from upstream 9 — must be >= 2 to avoid div-by-zero in demod_afsk_init */
#endif
...
#ifndef MAX_SLICERS
#define MAX_SLICERS 3     /* wfweb: shrunk from upstream 9 */
#endif
...
/* wfweb: glibc declares strcasestr in string.h with a different signature
   (const-preserving overloads). Gate to Windows only, where it's missing. */
#if __WIN32__
