...
// wfweb vendor: BuildMessageFramesThread::ctor + run() removed. (See
// Varicode.h for rationale — that QThread subclass is GUI-side glue
// JS8Call uses to background buildMessageFrames; we don't need it.)
