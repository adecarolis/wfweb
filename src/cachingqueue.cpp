...
cacheItem cachingQueue::getCache(funcs func, uchar receiver)
{
    ...
    if (func != funcNone && func != funcPowerControl && func != funcSelectVFO && func != funcDuplexMode && (!ret.value.isValid() || ret.reply.addSecs(QRandomGenerator::global()->bounded(5,20)) <= QDateTime::currentDateTime())) {
